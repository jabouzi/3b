...
{
    YAHOO.util.Connect.asyncRequest('POST', '/admin/get_familles', callback3);
...
function change_data(type)
{
    ...
    YAHOO.util.Connect.asyncRequest('POST', '/admin/change_data/'+type, callback4, postData);
}
...
{   
    ...
    YAHOO.util.Connect.asyncRequest('POST', '/admin/change_notes_data', callback4, postData);
}
...
function get_data(type)
{
    ...
    if (res != 0)
    {
        YAHOO.util.Connect.asyncRequest('POST', '/admin/get_data/'+res+'/'+type, callback); 
        YAHOO.util.Connect.asyncRequest('POST', '/admin/get_right_data/'+res, callback2);  
        YAHOO.util.Connect.asyncRequest('POST', '/admin/get_familles', callback3);
